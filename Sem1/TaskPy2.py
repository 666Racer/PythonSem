...
NumI = int(input('Номер вагона от головы поезда '))
NumJ = int(input('Номер вагона Вити '))
if NumI!=NumJ:
    print('В электричке {} вагонов'.format(int(NumJ+NumI-1)))
else:
    print('Без доп. информации невозможно узнать количество вагонов')